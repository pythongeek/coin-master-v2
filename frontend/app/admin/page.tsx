...
import { BarChart3, Settings, Users, ShieldCheck, Gift, Wallet, FileText, Key, Activity, LogOut, AlertCircle, type LucideIcon } from 'lucide-react';
...
const TABS: { id: 'live' | 'config' | 'users' | 'withdrawals' | 'bonuses' | 'audit' | 'health' | 'security' | 'kyc' | 'account'; label: string; Icon: LucideIcon }[] = [
