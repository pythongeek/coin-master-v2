...
import { BarChart3, Settings, Users, ShieldCheck, Gift, Wallet, FileText, Key, Activity, LogOut, AlertCircle, AlertOctagon, Trophy, Target, Coins, QrCode, Mail, SlidersHorizontal, Brain, Globe2, type LucideIcon } from 'lucide-react';
...
const TABS: { id: 'live' | 'config' | 'users' | 'withdrawals' | 'deposits' | 'bonuses' | 'leaderboard' | 'challenges' | 'audit' | 'system_logs' | 'health' | 'email' | 'security' | 'kyc' | 'kyc_admin' | 'account' | 'coins' | 'fraud' | 'settings' | 'ml' | 'audience' | 'geoip'; label: string; Icon: LucideIcon }[] = [
